...
if len(sys.argv) != 4:
    print('Use this script by entering: python %s Original_training new_exp output_name' % (sys.argv[0]))
    sys.exit()
...
training_data.ChangeExp(sys.argv[2])
print('Experimental data changed to %s' % sys.argv[2])
