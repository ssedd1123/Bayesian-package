...
from GUI.GridController.GridData import HistoryType, Direction
...
class MyGrid(gridlib.Grid):
    ...
    def __init__(self, parent, size, initial_df=None, **kwargs):
        ...
        self.Bind(gridlib.EVT_GRID_RANGE_SELECT, lambda evt: pub.sendMessage('Viewer_RangeSelected', obj=self, evt=evt))
...
class DataDirectionDialog(wx.Dialog):
    ...
    def __init__(self, parent, title):
        ...
        self.rb_left = wx.RadioButton(panel, label='Move left', pos=(10,10), style=wx.RB_GROUP)
        ...
        self.confirm_button = wx.Button(panel, label='Confirm', pos=(10,50), size=(100, 200))
